...
function show_chat_list() {
	...
	$("#chat_friends_list").load("http://<?php echo $_SERVER['HTTP_HOST'] ?>/orangechat/chatbar.php?act=chat_friends_list");
...
function update_chat_bar() {
	$("#chat_bar_content").load("http://<?php echo $_SERVER['HTTP_HOST'] ?>/orangechat/chatbar.php?act=update_chat_bar");
}
