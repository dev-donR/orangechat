...
function chatHeartbeat(){
	...
	$.ajax({
	  url: "http://<?php echo $_SERVER['HTTP_HOST'] ?>/orangechat/chat.php?action=chatheartbeat",
	  cache: false,
	  dataType: "json",
...
function closeChatBox(chatboxtitle) {
	...
	$.post("http://<?php echo $_SERVER['HTTP_HOST'] ?>/orangechat/chat.php?action=closechat", { chatbox: chatboxtitle} , function(data){	
	});
...
function checkChatBoxInputKey(event,chatboxtextarea,chatboxtitle) {
	...
	if(event.keyCode == 13 && event.shiftKey == 0)  {
		...
		if (message != '') {
			$.post("http://<?php echo $_SERVER['HTTP_HOST'] ?>/orangechat/chat.php?action=sendchat", {to: chatboxtitle, message: message} , function(data){
...
function startChatSession(){  
	$.ajax({
	  url: "http://<?php echo $_SERVER['HTTP_HOST'] ?>/orangechat/chat.php?action=startchatsession",
	  cache: false,
	  dataType: "json",
	  success: function(data) {
